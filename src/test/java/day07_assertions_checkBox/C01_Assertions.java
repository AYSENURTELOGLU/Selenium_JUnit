...
public class C01_Assertions {
    ...
    public void titleTesti(){
        ...
        Assert.assertFalse(actualIcerik.contains(unexpectedIcerik));
    }
    ...
    public void francaisTesti(){
        //○FrancaisLinkTest => Fransizca Linkin görüntülendiğini test edin
        WebElement francaisLinkTesti= driver.findElement(By.xpath("//button[normalize-space()='Français']"));
        Assert.assertTrue(francaisLinkTesti.isDisplayed());
