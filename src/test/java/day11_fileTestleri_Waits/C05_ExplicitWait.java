...
public class C05_ExplicitWait {
    ...
    public void test01(){
        ...
        /*
        görünmeyen bir elementi locate edemeyiz. locate edilmeyen bir elementi
        bekleyemeyiz.görünür olması için de beklememiz lazım

        explicit wait bekleme ve locate işlemini birlikte yapabilir.
        ...
        //itsback yazısının çıkması ve bizim locate etmemiz için beklelmiz gerekiyor
        WebElement itsBack=
